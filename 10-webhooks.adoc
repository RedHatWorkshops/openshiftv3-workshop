...
* Check *Push events* and add "master" to the text field
...
* Remove the line 16: `REMOVE ME TO TRIGGER THE WEBHOOK`.
* Commit the file to trigger a new build on OpenShift which will end up generating a new image and then a new deployment.
