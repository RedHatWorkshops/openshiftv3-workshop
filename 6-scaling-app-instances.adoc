...
Take a look at the `deploymentConfig` (or `dc`) of the `myhttpdapp`
application:
...
metadata:
  ...
  selfLink: /oapi/v1/namespaces/mycliproject-userxx/deploymentconfigs/myhttpdapp
...
spec:
  ...
  template:
    metadata:
      annotations:
        openshift.io/container.myhttpdapp.image.entrypoint: '["sh"]'
        openshift.io/generated-by: OpenShiftNewApp
    ...
    spec:
      containers:
      - image: 172.30.89.28:5000/mycliproject-userxx/myhttpdapp@sha256:c490ea632c5362be3a3985285c623e674e58b876e70d9e3f94a151785b2ee87c
  ...
  - imageChangeParams:
      ...
      from:
        ...
        namespace: mycliproject-userxx
      lastTriggeredImage: 172.30.89.28:5000/mycliproject-userxx/myhttpdapp@sha256:c490ea632c5362be3a3985285c623e674e58b876e70d9e3f94a151785b2ee87c
    type: ImageChange
status:
  availableReplicas: 1
  details:
