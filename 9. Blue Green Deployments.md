...
```
$ oc new-app --image-stream=php --code=https://github.com/RedHatWorkshops/bluegreen --name=blue
```
...
By default the application displays a blue square. For the sake of completeness; set the env var.

```
$ oc env dc/blue COLOR=blue
```
...
````
$ oc new-app --image-stream=php --code=https://github.com/RedHatWorkshops/bluegreen --name=green
````

Then edit the env var to make the square green

```
$ oc env dc/green COLOR=green
```
